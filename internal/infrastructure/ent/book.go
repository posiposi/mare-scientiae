...
type Book struct {
	...
	// GoogleBooksID holds the value of the "google_books_id" field.
	...
	for i := range columns {
		...
		case book.FieldGoogleBooksID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field google_books_id", values[i])
			} else if value.Valid {
				_m.GoogleBooksID = value.String
			}
...
func (_m *Book) String() string {
	...
	builder.WriteString("google_books_id=")
	builder.WriteString(_m.GoogleBooksID)
	builder.WriteString(", ")

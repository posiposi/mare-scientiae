...
func (m *BookMutation) AddAuthorIDs(ids ...uuid.UUID) {
	if m.authors == nil {
...
func (m *BookMutation) RemoveAuthorIDs(ids ...uuid.UUID) {
...
func (m *BookMutation) RemovedAuthorsIDs() (ids []uuid.UUID) {
...
func (m *BookMutation) AuthorsIDs() (ids []uuid.UUID) {
